                                ...
                                const occHandle(StlMesh_Mesh)& Mesh)
{
    ...
    {
        //cout<<"StlTransfer::RetrieveMesh()->____retrieving the triangulation from the face____"<<endl;
        ...
        {
            cout<<"StlTransfer::RetrieveMesh()->____the current face has not a mesh____"<<endl;
...
//#endif
    ...
    //cout<<"StlTransfer::RetrieveMesh()->____exiting function____"<<endl;
}
