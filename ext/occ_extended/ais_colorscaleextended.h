#ifndef AIS_ColorScaleExtendedEXTENDED_H
#define AIS_ColorScaleExtendedEXTENDED_H
...
class AIS_ColorScaleExtended : public AIS_InteractiveObject
{

public:

  //! Default constructor.
  Standard_EXPORT AIS_ColorScaleExtended();
  ...
  DEFINE_STANDARD_RTTIEXT(AIS_ColorScaleExtended,AIS_InteractiveObject)
...
protected:
  ...
  Standard_EXPORT void drawFrame (const occHandle(Prs3d_Presentation)& thePresentation,
  ...
  Standard_EXPORT void drawText (const occHandle(Prs3d_Presentation)& thePresentation,
...
private:
  ...
  void ComputeSelection (const occHandle(SelectMgr_Selection)& /*aSelection*/,
...
Q_DECLARE_METATYPE(AIS_ColorScaleExtended)

#endif // AIS_ColorScaleExtendedEXTENDED_H
