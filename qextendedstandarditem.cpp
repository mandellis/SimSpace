...
QVariant QExtendedStandardItem::data(int role) const
{
    if(role==Qt::DisplayRole)
    {
        ...
        //! ------------------------------------------------------------------------
        //! "Initial time step" "Minimum time step" "Maximum time step" "Time step"
        //! ------------------------------------------------------------------------
        else if(name =="Initial time step" || name =="Minimum time step" || name =="Maximum time step" || name =="Time step")
        {
            double val = QStandardItem::data(Qt::UserRole).value<Property>().getData().toDouble();
...
QIcon QExtendedStandardItem::getIcon(SimulationNodeClass::nodeType theNodeType) const
{
    ...
    case SimulationNodeClass::nodeType_particlesInFieldsParticlePack: return QIcon(":/icons/icon_points.png"); break;
