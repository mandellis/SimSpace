#ifndef TRIANGLETOTRIANGLEINTERSECTION_H
#define TRIANGLETOTRIANGLEINTERSECTION_H
...
namespace TriangleToTriangleIntersection
{
...

{
    ...
    //! ----------------------------------------------
    //! comment: this part must NOT be commented - GB
    //! ----------------------------------------------
    // added by Aaron
...
#endif // TRIANGLETOTRIANGLEINTERSECTION_H
