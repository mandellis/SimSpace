...
//! details:
//! ----------------------
TabularDataViewerClass1::TabularDataViewerClass1(QWidget *parent):QCustomPlot(parent)
{
    //! ------------------
    //! mouse tracking on
    //! ------------------
...
//! details:
//! ---------------------
void TabularDataViewerClass1::showLegend()
{
    myLegendIsVisible = true;
...
//! details:
//! ---------------------
void TabularDataViewerClass1::hideLegend()
{
...
//! details:
//! --------------------------
void TabularDataViewerClass1::ShowContextMenu(QPoint pos)
{
...
//! details:
//! -------------------
void TabularDataViewerClass1::showAxes()
{
...
//! details:
//! -------------------
void TabularDataViewerClass1::hideAxes()
{
...
//! -------------------------------------------------------------
void TabularDataViewerClass1::plotXYs()
{
    //! -----------------
    //! clear all graphs
    //! -----------------
...
//! details:
//! --------------------
void TabularDataViewerClass1::showData(CustomTableModel *tabData, const QList<int> &columnsToShow)
{
    //cout<<"TabularDataViewerClass1::showData1()->____function called____"<<endl;
    ...
    //cout<<"TabularDataViewerClass1::showData1()->____exiting function____"<<endl;
}
...
//! detail:
//! -----------------------
void TabularDataViewerClass1::updateViewer()
{
    //cout<<"TabularDataViewerClass1::updateViewer()->____function called____"<<endl;
    this->plotXYs();
}
...
//! details:
//! ---------------------
void TabularDataViewerClass1::clearPanel()
{
    //cout<<"TabularDataViewerClass1::clearPanel()->____function called____"<<endl;
...
//! details:
//! -------------------------
void TabularDataViewerClass1::mouseMoveEvent(QMouseEvent *event)
{
    //cout<<"TabularDataViewerClass1::mousePressEvent()->____MOUSE MOVE____"<<endl;
    myX = event->pos().x();
    myY = event->pos().y();
}
...
//! details:
//! --------------------------
void TabularDataViewerClass1::mousePressEvent(QMouseEvent *event)
{
    cout<<"TabularDataViewerClass1::mousePressEvent()->____MOUSE PRESS____"<<endl;
    myX = event->pos().x();
    myY = event->pos().y();
}
...
//! details:
//! --------------------
void TabularDataViewerClass1::saveImage()
{
